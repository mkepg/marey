...
export const App: FunctionComponent = () => {
  ...
  const { ratio: hRatio, isDragging: isHDragging, onHandlePointerDown: onHPointerDown } = useSplitPane({
    axis: "horizontal",
    initial: 0.52,
    min: 0.2,
    max: 0.8,
  ...
  const { ratio: vRatio, isDragging: isVDragging, onHandlePointerDown: onVPointerDown } = useSplitPane({
    axis: "vertical",
    initial: 0.75,
    min: 0.3,
    max: 0.88,
    ...
    <div className={styles.app} data-theme={theme}>
      ...
      <div className={styles.split} ref={containerRef}>
        <div className={styles.leftPane} ref={leftPaneRef} style={{ width: leftW }}>
          ...
          {/* Prevent Monaco from swallowing pointer events during resize */}
          <div className={styles.editorWrap} style={{ height: editorH, pointerEvents: isDragging ? "none" : "auto" }}>
        ...
        {/* Prevent PixiJS canvas from swallowing pointer events during resize */}
        <div className={styles.rightPane} style={{ width: rightW, pointerEvents: isDragging ? "none" : "auto" }}>
